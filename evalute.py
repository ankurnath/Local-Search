...
def test_GNN(distribution,model):
    
    current_directory=os.getcwd()
    model_load_path=os.path.join(current_directory,"pretrained agents",f'{distribution}_{model}')
...
if __name__ == '__main__':
    ...
    test_GNN(distribution=args.distribution,model=args.model)